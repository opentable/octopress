...
<table style="margin-bottom:16px;">
    <tr>
        <th style="font-weight:bold;padding:5px 10px;">Method</th>
        <th style="font-weight:bold;padding:5px 10px;">Operation performed</th> 
        <th style="font-weight:bold;padding:5px 10px;">Quality</th>
    </tr>
    <tr>
        <td style="padding:5px 10px;">**GET**</td>
        <td style="padding:5px 10px;">Read a resource</td> 
        <td style="padding:5px 10px;">Safe</td>
    </tr>
    <tr>
        <td style="padding:5px 10px;">**POST**</td>
        <td style="padding:5px 10px;">Insert a new resource, or update an existing one</td> 
        <td style="padding:5px 10px;">Not idempotent</td>
    </tr>
    <tr>
        <td style="padding:5px 10px;">**PUT**</td>
        <td style="padding:5px 10px;">Insert a new resource, or update an existing one</td> 
        <td style="padding:5px 10px;">Idempotent (see below)</td>
    </tr>
    <tr>
        <td style="padding:5px 10px;">**DELETE**</td>
    ...
    <tr>
        <td style="padding:5px 10px;">**HEAD**</td>
...
<table style="margin-bottom:16px;">
    <tr>
        <th style="font-weight:bold;padding:5px 10px;">Header</th>
        <th style="font-weight:bold;padding:5px 10px;">Application</th>
    </tr>
    <tr>
